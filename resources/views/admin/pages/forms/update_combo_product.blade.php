                            ...
                            <div class="form-group">
                                <label for="seller_id" class="form-label">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       ...
                                       data-bs-content="Select the seller for this combo product."></i>
                                </label>
                            ...
                            <div class="form-group">
                                <label for="product_type" class="form-label">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="Select whether the combo contains physical or digital products."></i>
                                </label>
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="brand_name" class="form-label">
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="Enter the combo product name."></i>
                                    </label>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <label for="short_description" class="form-label mb-0">
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1"
                                               data-bs-toggle="popover"
                                               data-bs-placement="right"
                                               data-bs-content="Enter a short description for the combo product."></i>
                                        </label>
                            ...
                            <div class="form-group">
                                <label for="tags" class="form-label">
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="Enter tags for the combo product, separated by commas."></i>
                                </label>
                                ...
                                <div class="mb-3 search_admin_product_for_combo_parent">
                                    <label class="form-label"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="Select physical products to include in the combo."></i>
                                    </label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="Select digital products to include in the combo."></i>
                                    </label>
                        ...
                        <div class="col-md-12 col-xs-12 {{ $data->has_similar_product == '1' ? '' : 'd-none' }}"
                            ...
                            <label for="similar_product"
                                ...
                                <i class="fa fa-info-circle text-secondary ms-1"
                                   data-bs-toggle="popover"
                                   data-bs-placement="right"
                                   data-bs-content="Select similar products for this combo."></i>
                            </label>
                            ...
                            <div class="form-group">
                                <label for="cancelable_till"
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="Select the status till which the combo can be canceled."></i>
                                </label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="simple_price"
                                                                ...
                                                                <i class="fa fa-info-circle text-secondary ms-1"
                                                                   data-bs-toggle="popover"
                                                                   data-bs-placement="right"
                                                                   data-bs-content="Enter the combo product price."></i>
                                                            </label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="weight"
                                                                        ...
                                                                        <i class="fa fa-info-circle text-secondary ms-1"
                                                                           data-bs-toggle="popover"
                                                                           data-bs-placement="right"
                                                                           data-bs-content="Enter the combo product weight in kg."></i>
                                                                    </label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="height"
                                                                        ...
                                                                        <i class="fa fa-info-circle text-secondary ms-1"
                                                                           data-bs-toggle="popover"
                                                                           data-bs-placement="right"
                                                                           data-bs-content="Enter the combo product height in cms."></i>
                                                                    </label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="breadth"
                                                                        ...
                                                                        <i class="fa fa-info-circle text-secondary ms-1"
                                                                           data-bs-toggle="popover"
                                                                           data-bs-placement="right"
                                                                           data-bs-content="Enter the combo product breadth in cms."></i>
                                                                    </label>
                                                                    <input type="number" min=0 class="form-control"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="length"
                                                                        ...
                                                                        <i class="fa fa-info-circle text-secondary ms-1"
                                                                           data-bs-toggle="popover"
                                                                           data-bs-placement="right"
                                                                           data-bs-content="Enter the combo product length in cms."></i>
                                                                    </label>
                                                                    <input type="number" min=0 class="form-control"
                                                    ...
                                                    <div class="form-group">
                                                        <label for=""
                                                            ...
                                                            <i class="fa fa-info-circle text-secondary ms-1"
                                                               data-bs-toggle="popover"
                                                               data-bs-placement="right"
                                                               data-bs-content="Enter the total stock quantity."></i>
                                                        </label>
                                            ...
                                            <div class="col-md-6 {{ isset($data->download_type) && $data->download_type == 'add_link' ? '' : 'd-none' }}"
                                                ...
                                                <label for="video" class="col form-label ml-1">
                                                    ...
                                                    <i class="fa fa-info-circle text-secondary ms-1"
                                                       data-bs-toggle="popover"
                                                       data-bs-placement="right"
                                                       data-bs-content="Paste the digital product link or URL here."></i>
                                                </label>
