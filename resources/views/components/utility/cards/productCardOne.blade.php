            ...
            <div class="product-details">
                ...
                <div>
                    ...
                    <a wire:navigate href="{{ customUrl('categories/' . $details->category_slug . '/products') }}"
                        ...
                        title="{!! app(TranslationService::class)->getDynamicTranslation(Category::class, 'name', $details->category_id, $language_code) !!}"><ion-icon name="layers-outline"
                ...
                @else
                    <div class="button-action mt-2">
                        <div class="addtocart-btn add_cart" id="add_cart"
                            ...
                            data-slug='{{ $details->slug }}' data-image='{{ app(MediaService::class)->dynamic_image($details->image, 220) }}'
