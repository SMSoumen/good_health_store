...
@endsection
@section('content')
    <x-seller.breadcrumb :title="labels('admin_labels.update_sticker', 'Update Sticker')" :subtitle="labels('admin_labels.manage_reusable_product_stickers', 'Create reusable stickers (icon + text) to attach to products')" :breadcrumbs="[['label' => labels('admin_labels.update_sticker', 'Update Sticker')]]" />
    @php
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="form-group">
                    <form action="{{ url('/seller/stickers/update/' . $data->id) }}" enctype="multipart/form-data"
