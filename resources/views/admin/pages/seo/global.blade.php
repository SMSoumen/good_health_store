...
@section('content')
    <x-admin.breadcrumb title="Global SEO Settings" subtitle="Configure default SEO settings for your website"
        :breadcrumbs="[['label' => 'SEO', 'url' => route('admin.seo.index')], ['label' => 'Global Settings']]" />
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Global SEO Settings</h4>
                        <p class="text-muted">Configure default SEO settings for your website</p>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.seo.global.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description"
                                            name="meta_description" rows="3" maxlength="160" placeholder="Enter meta description (max 160 characters)">{{ old('meta_description', $seo->meta_description ?? '') }}</textarea>
                                        <small class="text-muted">Character count: <span
                            ...
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h5>Open Graph Tags (Facebook, LinkedIn)</h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit"
                                    class="btn btn-primary submit_button text-white">{{ labels('admin_labels.save_settings', 'Save Global SEO Settings') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
