                ...
                <div class="modal-body">
                    ...
                    <div class="alert {{ $shiprocket_enabled ? 'alert-warning' : 'alert-info' }} mb-3" role="alert">
                        <h6 class="alert-heading">
                            ...
                            {{ $shiprocket_enabled ? 'Standard Shipping (Shiprocket)' : 'Local Shipping' }}
                        </h6>
                        <p class="mb-0 small">
                            @if ($shiprocket_enabled)
                                This order will be shipped using <strong>Shiprocket courier partners</strong>.
                                You can create parcels, generate AWB, and track shipments below.
                            @else
                                This order will be shipped using <strong>your local delivery team</strong>.
                        ...
                        <div class="shiprocket_order_box">
                            <div class="card card-info mb-4">
                                <div class="card-header bg-dark text-white">
                                    <h6 class="mb-0 text-white">Create Shiprocket Order</h6>
                                </div>
                                <div class="card-body">
