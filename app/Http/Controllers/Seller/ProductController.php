...
class ProductController extends Controller
{
    ...
    public function list()
    {
        ...
        $products = $products->map(function ($p) use ($language_code) {
            ...
            ? '<span class="badge bg-warning text-dark"><i class="bx bx-error-circle me-1"></i>Missing Config</span>'
            : '<span class="badge bg-success"><i class="bx bx-check-circle me-1"></i>Configured</span>',
