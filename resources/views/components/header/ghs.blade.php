        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-4 text-right d-flex align-items-center justify-content-end">
                    {{-- GHS social icons (moved here from the main header, replacing
                         the language + currency pickers) --}}
                    <div class="ghs-social d-inline-flex align-items-center">
                        @if (!empty($settings->facebook_link))
                            <a href="{{ $settings->facebook_link }}" target="_blank" title="Facebook"><i
                                    class="anm anm-facebook"></i></a>
                        @endif
                        @if (!empty($settings->instagram_link))
                            <a href="{{ $settings->instagram_link }}" target="_blank" title="Instagram"><i
                                    class="anm anm-instagram"></i></a>
                        @endif
                        @if (!empty($settings->linkedin_link))
                            <a href="{{ $settings->linkedin_link }}" target="_blank" title="LinkedIn"><i
                                    class="anm anm-linkedin"></i></a>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-1 col-sm-1 col-md-1 col-lg-7 align-self-center d-menu-col">
                    <nav class="navigation" id="AccessibleNav">
                        <ul id="siteNav" class="site-nav medium center">
                            ...
                            <li class="lvl1 parent dropdown"><a wire:navigate
                                    href="{{ customUrl('about_us') }}">{{ labels('front_messages.our_story', 'Our Story') }}</a>
                            </li>
                            <li class="lvl1 parent megamenu"><a wire:navigate
                                    href="{{ customUrl('products') }}">{{ labels('front_messages.food', 'Food') }}</a>
                            </li>
                            <li class="lvl1 parent megamenu"><a wire:navigate
                                    href="{{ customUrl('products') }}">{{ labels('front_messages.oils', 'Oils') }}</a>
                            </li>
                            <li class="lvl1 parent megamenu"><a wire:navigate
                                    href="{{ customUrl('products') }}">{{ labels('front_messages.women', 'Women') }}</a>
                            </li>
                            <li class="lvl1 parent megamenu"><a wire:navigate
                                    href="{{ customUrl('products') }}">{{ labels('front_messages.men', 'Men') }}</a>
                            </li>
                            <li class="lvl1 parent megamenu"><a wire:navigate
                                    href="{{ customUrl('combo-products') }}">{{ labels('front_messages.combo_deals', 'Combo Deals') }}</a>
                            </li>
                            <li class="lvl1 parent dropdown"><a wire:navigate
                                    href="{{ customUrl('bulk_gifting_orders') }}">{{ labels('front_messages.bulk_gifting_orders', 'Bulk/Gifting Orders') }}</a>
                            </li>
                            <li class="lvl1 parent dropdown"><a wire:navigate
                                    href="{{ customUrl('contact_us') }}">{{ labels('front_messages.contact_us', 'Contact Us') }}</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="col-7 col-sm-9 col-md-9 col-lg-3 align-self-center icons-col text-right">
                    ...
                    <!--End Minicart-->
                    {{-- Buy Now button hidden per request
                    <a wire:navigate href="{{ customUrl('products') }}"
                        class="ghs-buy-now d-none d-lg-inline-flex">{{ labels('front_messages.buy_now', 'Buy Now') }}</a>
                    --}}
                    <!--Mobile Toggle-->
                    <button type="button"
