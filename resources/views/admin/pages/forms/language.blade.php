                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="language" name="language"
                                        placeholder="English" value="{{ old('language') }}">
                                    <small
                            ...
                            <div class="row g-3 mb-3">
                                @php
                                    $labelFiles = [
                                        ...
                                        'web' => 'Web Labels',
                                        'app' => 'App Labels',
                                        'seller' => 'Seller App Labels',
                                        'delivery' => 'Delivery App Labels',
                                    ];
                                @endphp
                                @foreach ($labelFiles as $type => $label)
                                    <div class="col-12">
                                        ...
                                        <input type="file" name="translation_files[{{ $type }}]"
                                            ...
                                            class="form-control translation-file-input create-translation-file">
                                        <small class="text-muted">JSON or PHP file for {{ strtolower($label) }}.</small>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                                ...
                                @foreach ($labelFiles as $type => $label)
                                    <div class="col-12">
                                        ...
                                        <input type="file" name="translation_files_select[{{ $type }}]"
                                            ...
                                            class="form-control translation-file-input select-translation-file">
                                        <small class="text-muted">JSON or PHP file for {{ strtolower($label) }}.</small>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="download_file_type" id="download_file_type" class="form-control form-select">
                                ...
                                <option value="app">App (Customer)</option>
