                        ...
                        <div class="col-md-6">
                            <label for="seller_id" class="form-label">
                                ...
                                <i class="fa fa-info-circle text-secondary ms-1"
                                   ...
                                   data-bs-content="Select the seller for this product."></i>
                            </label>
                                ...
                                <div class="col-md-6">
                                    <label for="brand_name" class="form-label">
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="Enter the product name."></i>
                                    </label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="weight" class="form-label col-md-12">
                                                                        ...
                                                                        <i class="fa fa-info-circle text-secondary ms-1"
                                                                           data-bs-toggle="popover"
                                                                           data-bs-placement="right"
                                                                           data-bs-content="Enter the product weight in kg."></i>
                                                                    </label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="height" class="form-label col-md-12">
                                                                        ...
                                                                        <i class="fa fa-info-circle text-secondary ms-1"
                                                                           data-bs-toggle="popover"
                                                                           data-bs-placement="right"
                                                                           data-bs-content="Enter the product height in cms."></i>
                                                                    </label>
