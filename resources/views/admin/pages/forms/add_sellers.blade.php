                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="mobile"
                                                maxlength="16" placeholder="8787878787"
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    ...
                                                    data-bs-content="Upload the seller's profile image."></i>
                                            </label>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Upload a document as address proof."></i>
                                            </label>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Upload the authorized signature document."></i>
                                            </label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="commission"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Set the global commission percentage for this seller."></i>
                                    </label>
                                ...
                                <div class="form-group row">
                                    <label for="commission"
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                            data-bs-placement="right"
                                            data-bs-content="Set commission for specific categories."></i>
                                    </label>
                                ...
                                <div class="form-group col-md-6">
                                    <div class="">
                                        ...
                                        <a href="javascript:void(0)" id="seller_model"
                                            ...
                                            title="Manage Categories & Commission" data-bs-toggle="offcanvas"
                                    ...
                                    <div class="alert alert-info mt-3 mb-3" role="alert">
                                        ...
                                        <ul class="mb-0 small text-dark">
                                            ...
                                            <li><strong>Step 4:</strong> <span class="text-danger fw-bold">IMPORTANT:</span> Finally, click the <strong>"Add Seller"</strong> button at the bottom of this page to permanently save all changes.</li>
                                        </ul>
                                        <hr class="my-2 text-primary">
                                        <h6 class="alert-heading fw-bold mb-1 mt-2">Commission Logic:</h6>
                                        <ul class="mb-0 small text-dark">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="national_identity_card"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Upload the seller's national identity card."></i>
                                            </label>
                                            <div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="require_products_approval"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Enable if products require approval before being listed."></i>
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="customer_privacy"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Enable if seller can view customer details."></i>
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="view_order_otp"
                                                ...
                                                <i class="fa fa-info-circle text-secondary ms-1" data-bs-toggle="popover"
                                                    data-bs-placement="right"
                                                    data-bs-content="Enable if seller can view order OTP and change delivery status."></i>
                                            </label>
