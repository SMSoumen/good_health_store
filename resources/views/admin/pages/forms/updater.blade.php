...
@section('content')
    ...
    <div class="row">
        ...
        <div class="alert alert-info alert-dismissible" role="alert">
            {{ __('If your package includes web files, upload the web updater file immediately after uploading the update file.') }}
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        <div class="alert alert-success alert-dismissible" role="alert">
            {{ __('If your package includes app files, change the app file immediately after uploading the update file. As per the update guide.') }}
            <a href="https://drive.google.com/drive/folders/1kHeOsufjaZu-XxrfGMKYJPfF2BU9VS2X?usp=drive_link" target="_blank" class="alert-link">
                <strong>{{ __('View Update Guide') }}</strong>
            </a>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        <div class="card">
