    ...
    public function productSeoList(Request $request)
    {
        ...
        $rows = $products->map(function ($product) use ($languageCode) {
            ...
            return [
                ...
                'actions' => '<a href="' . route('admin.seo.products.edit', $product->id) . '" class="btn btn-sm btn-primary text-white"><i class="fas fa-edit"></i> Edit SEO</a>',
            ];
        });
    ...
    public function categorySeoList(Request $request)
    {
        ...
        $rows = $categories->map(function ($category) use ($languageCode) {
            ...
            return [
                ...
                'seo_status' => $seo ? '<span class="badge bg-success">Configured</span>' : '<span class="badge bg-warning">Not Configured</span>',
                'meta_title' => $seo?->meta_title ?? '-',
                'actions' => '<a href="' . route('admin.seo.categories.edit', $category->id) . '" class="btn btn-sm btn-primary text-white"><i class="fas fa-edit"></i> Edit SEO</a>',
            ];
        });
    ...
    public function blogSeoList(Request $request)
    {
        ...
        $rows = $blogs->map(function ($blog) use ($languageCode) {
            ...
            return [
                ...
                'seo_status' => $seo ? '<span class="badge bg-success">Configured</span>' : '<span class="badge bg-warning">Not Configured</span>',
                'meta_title' => $seo?->meta_title ?? '-',
                'actions' => '<a href="' . route('admin.seo.blogs.edit', $blog->id) . '" class="btn btn-sm btn-primary text-white"><i class="fas fa-edit"></i> Edit SEO</a>',
            ];
        });
