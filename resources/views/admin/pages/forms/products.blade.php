                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" name="weight"
                                                                    placeholder="Weight" id="weight" min=0
                                                                    value="0" step="0.01">
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" name="height"
                                                                    placeholder="Height" id="height" min=0
                                                                    value="0" step="0.01">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" name="breadth"
                                                                    placeholder="Breadth" id="breadth" min=0
                                                                    value="0" step="0.01">
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                ...
                <div class="card p-5">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6 d-none" id="video_media_container">
                            <label for="" class="form-label">Video<span class="text-asterisks text-sm">*</span>
                            </label>
                            <div class="form-group">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label small" for="custom_extra_description_prompt_toggle">Custom
                                    Prompt</label>
                            </div>
