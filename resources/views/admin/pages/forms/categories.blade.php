            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="commissionLabel">
                        Set Commission & Approve Category
                    </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="commissionPercentage" name="commission" class="form-control"
                                placeholder="Enter commission percentage" min="0" max="100" step="0.01" required>
                            <small class="form-text text-muted">
                                Enter commission percentage for the seller (0-100%)
                            </small>
                        </div>
                    </div>
