                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="alert-heading mb-1">
                            {{ labels('admin_labels.products_missing_config', 'Products Missing Configuration') }}</h5>
                        <p class="mb-2">
                            {{ $misconfigured_products_count }}
                            {{ $misconfigured_products_count == 1 ? 'product is' : 'products are' }} missing required
                            shipping configuration.
                            Please update your products to ensure they can be delivered.
                        </p>
