                            ...
                            <div class="form-group">
                                <label for=""
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       ...
                                       data-bs-content="Choose whether to send notification to all sellers or specific sellers."></i>
                                </label>
                            ...
                            <div class="form-group row notification-sellers d-none">
                                <label for="user_id"
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="Select sellers to receive the notification."></i>
                                </label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label for="type"
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="Select the type of notification (Default, Notification URL)."></i>
                                </label>
                                ...
                                <div class="form-group notification-url d-none">
                                    <label for="notification_url">{{ labels('admin_labels.link', 'Link') }}
                                        ...
                                        <i class="fa fa-info-circle text-secondary ms-1"
                                           data-bs-toggle="popover"
                                           data-bs-placement="right"
                                           data-bs-content="Enter a URL to send with the notification."></i>
                                    </label>
                            ...
                            <div class="form-group">
                                <label for="title"
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="Enter the notification title."></i>
                                </label>
                            ...
                            <div class="form-group">
                                <label for="message"
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="Enter the notification message."></i>
                                </label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="image_checkbox"
                                            ...
                                            <i class="fa fa-info-circle text-secondary ms-1"
                                               data-bs-toggle="popover"
                                               data-bs-placement="right"
                                               data-bs-content="Enable to include an image with the notification."></i>
                                        </label>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="form-group d-none include_image col-md-8 mt-4">
                                <label for="image" class="mb-2">{{ labels('admin_labels.image', 'Image') }}
                                    ...
                                    <i class="fa fa-info-circle text-secondary ms-1"
                                       data-bs-toggle="popover"
                                       data-bs-placement="right"
                                       data-bs-content="Upload an image for the notification. Recommended size: 80x80 pixels."></i>
                                </label>
                                <div class="col-md-12">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_seller_notification_table','csv')">CSV</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_seller_notification_table','json')">JSON</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_seller_notification_table','sql')">SQL</button>
                                                </li>
                                                <li><button class="dropdown-item" type="button"
                                                        onclick="exportTableData('admin_seller_notification_table','excel')">Excel</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
